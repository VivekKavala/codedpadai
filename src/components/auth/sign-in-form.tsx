...
import { loginUser } from '@/app/actions/auth'; // Path updated
  ...
  return (
    <form action={handleSubmit} className="mt-8 space-y-6">
      ...
      <div className="rounded-md shadow-sm -space-y-px">
        ...
        <div className="relative">
          ...
          <input
            ...
            required
            // 5. Add padding-right for the icon
      ...
      <div className="flex items-center justify-between">
        {/* ... existing remember-me and forgot password ... */}
      ...
      <div className="mt-6">
        {/* ... existing 'Or continue with' and OAuth buttons ... */}
        <div className="relative">
